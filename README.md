...
## What I learned
Where to put the state. In this case `darkMode` is put in App component. Function `setDarkMode` is located in App but passed as a prop down to Navbar component where it is called from an onClick event on the toggle switch.
